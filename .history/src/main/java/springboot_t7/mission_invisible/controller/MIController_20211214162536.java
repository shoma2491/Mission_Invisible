...
public class MIController {
   ...
   */
    ...
    @GetMapping("/wait")
    public String Wait(Principal prin, ModelMap model) {      String loginUser = prin.getName();      if(this.game.roleId(loginUser) == 1){        this.roomWait.addUser(loginUser);      }      int userRoleLength = this.roomWait.getUserslength();      model.addAttribute("userRoleLength", userRoleLength);      return "wait.html";    }
