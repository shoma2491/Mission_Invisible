    ...
    public boolean userTurnResult(String userName){
        ...
        for (Integer findUserId : findUserIds) {
            if(findUserId.intValue() == userId){
                if(userId == 1){
                    this.resultMapper.updateUser1(1, this.turn);
                }else if(userId == 2){
                    this.resultMapper.updateUser2(1, this.turn);
                }else if(userId == 3){
                    this.resultMapper.updateUser3(1, this.turn);
                }
                return true;
            }
        }
